...
def start_bot():
    while True:
        try:
            ...
            print(f"[+] SUCCESS: Bot @{BOT_USERNAME} is LIVE with Strict Single-Message Logic! 🚀")

            seen_message_ids = set()
            group_members_state = {}
            ever_seen_members = set()
            processed_joins = set() # डबल मैसेज रोकने के लिए परमानेंट ट्रैकिंग सेट
            is_first_run = True
            ...
            while True:
                try:
                    ...
                    for thread in threads:
                        ...
                        # 1. WELCOME & WELCOME BACK LOGIC (STRICT SINGLE MESSAGE FIX)
                        if thread_id in group_members_state:
                            ...
                            if newly_joined and not is_first_run:
                                for joined_pk in newly_joined:
                                    # अगर इस यूजर को इस सेशन में पहले ही वेलकम कर चुके हैं, तो दोबारा कभी नहीं भेजेंगे
                            ...
                            if last_msg.id not in seen_message_ids:
                                ...
                                if not is_sender_admin:
                                    ...
                                    if item_type in ['clip', 'media', 'video', 'visual_media'] or '/reel/' in text_lower or 'video' in item_type:
                                        reel_msg = (
                                            f"🚫🎬 𝗥𝗘𝗘𝗟𝗦 𝗡𝗢𝗧 𝗔𝗟𝗟𝗢𝗪𝗘𝗗!\n\n"
                                            f"👤 @{sender_username}\n\n"
                                            f"⚠️ 𝗥𝗘𝗘𝗟𝗦 / 𝗩𝗜𝗗𝗘𝗢𝗦 𝗔𝗥𝗘 𝗡𝙾𝗧 𝗔𝗟𝗟𝗢𝗪𝗘𝗗 𝗛𝗘𝗥𝗘.\n\n"
                                ...
                                if "@everyone" in text_lower or bot_tag in text_lower:
                                    response_msg = (
                                        ...
                                        f"🤖 𝗕𝗢𝗧 𝗜𝗦 𝗔𝗖𝗧𝗜𝗩𝗘 𝗔𝗡𝗗 𝗠𝗔𝗡𝗔𝗚𝗜𝗡𝙶 𝗧𝗛𝗘 𝙶𝙲 𝚂𝙼𝙾𝙾𝚃𝙷𝙻𝚈. 🚀\n\n"
                                        f"🤖 𝗕𝗢𝗧 ➜ @{BOT_USERNAME}\n"
                                        f"👨‍💻 𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥 ➜ @{OWNER_USERNAME}"
                                    )
