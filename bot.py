...
POLL_INTERVAL = 0.4  # Ultra-fast response rate
...
# --- Bulletproof Abuse & Evasion Regex Filters ---
...
class ModerationEngine:
    ...
    def get_user_stats(username: str) -> str:
        ...
        try:
            ...
            profile = db.query(UserProfile).filter(UserProfile.username == clean_user).first()
            if profile:
                reg_date = profile.join_date.strftime('%Y-%m-%d %H:%M:%S UTC') if profile.join_date else "Unknown"
                return (
                    f"📊✨ 𝗚𝗢𝗗-𝗠𝗢𝗗𝗘 • 𝗨𝗦𝗘𝗥 𝗧𝗥𝗨𝗦𝗧 𝗖𝗔𝗥𝗗 ✨📊\n\n"
                    f"👤 𝗨𝗦𝗘𝗥 ➜ {fix_mention(profile.username)}\n"
                    f"🆔 𝗨𝗦𝗘𝗥 𝗜𝗗 ➜ `{profile.user_id}`\n"
                    f"📅 𝗚𝗖 𝗝𝗢𝗜𝗡𝗘𝗗 ➜ {reg_date}\n"
    ...
    def get_history_stats(username: str) -> str:
        ...
        try:
            ...
            return (
                f"📜🔍 𝗛𝗜𝗦𝗧𝗢𝗥𝗬 • 𝗖𝗛𝗔𝗡𝗚𝗘 𝗖𝗔𝗥𝗗 🔍📜\n\n"
                f"❌ History data not found for {fix_mention(clean_user)}!\n\n"
                f"🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}\n"
                f"👑 𝗗𝗘𝗩 ➜ {OWNER_USERNAME}"
            )
        finally:
        ...
        try:
            ...
            def safe_send_message(thread_id, text_content, reply_to_item_id=None):
                ...
                if thread_id in recent_sent_texts:
                    ...
                    if last_text == text_content and (current_time - last_time < 0.4):
                        return
            ...
            while True:
                try:
                    ...
                    for thread in threads:
                        ...
                        # --- Fixed Time Morning Wish (6:00 AM) ---
                        ...
                        # --- Fixed Time Night Wish (10:30 PM) ---
                        ...
                        if messages:
                            ...
                            if message_id and message_id not in seen_message_ids:
                                ...
                                # --- ZERO-TOLERANCE ABUSE & SPAM KICK ENGINE ---
                                if not is_dev:
                                    ...
                                    if is_abuse or is_reel_or_link or is_nsfw_content:
                                        if is_abuse:
                                            violation_reason = "Zero-Tolerance Abuse / Toxic Slang Detected"
                                ...
                                if text_lower == "!rules":
                                    if is_dev:
                                        rules_card = (
                                            ...
                                            f"🚫 𝗡𝗢 𝗔𝗕𝗨𝗦𝗘 • 𝗡𝗢 𝗧𝗢𝗫𝗜𝗖𝗜𝗧𝗬 (𝗜𝗡𝗦𝗧𝗔𝗡𝗧 𝗞𝗜𝗖𝗞)\n"
                                ...
                                if text_lower == "!botinfo":
                                    if is_dev:
                                        info_card = (
                                            f"🤖📊 𝗕𝗢𝗧 𝗜𝗡𝗙𝗢 • 𝗚𝗢𝗗-𝗠𝗢𝗗𝗘 📊🤖\n\n"
                                            f"⚡ 𝗦𝗧𝗔𝗧𝗨𝗦 ➜ 𝟭𝟬𝟬% 𝗢𝗡𝗟𝗜𝗡𝗘\n"
                                            f"🛡️ 𝗠𝗢𝗗𝗘𝗥𝗔𝗧𝗜𝗢𝗡 ➜ 𝗜𝗡𝗦𝗧𝗔𝗡𝗧 𝗔𝗕𝗨𝗦𝗘 𝗞𝗜𝗖𝗞\n"
                                ...
                                if text_lower in ["!help", "!commands", "!menu"]:
                                    if is_dev:
                                        help_card = (
                                            ...
                                            f"➜ `!stats <username>` : User Trust Score & Activity\n"
                                            f"➜ `!history <username>` : Username & Name Change History\n"
                                            f"➜ `!topchatters` : GC Activity Leaderboard\n"
                                            f"➜ `!profile <username>` : Deep Profile Info (ID, Verified, Created Date)\n"
                                            f"➜ `!members` : Member List Count\n"
                                            f"➜ `!admins` : Admin List Count\n"
                                            f"➜ `!security` : GC Security Status Card\n"
                                    ...
                                    if is_dev:
                                        ...
                                        try:
                                            ...
                                            if u_info:
                                                ...
                                                is_verified = "Yes ✅ (Meta Verified)" if getattr(u_info, 'is_verified', False) else "No ❌"
                                                
                                                account_created_hint = "Older Account / Standard"
                                                pk_val = int(u_info.pk)
                                                if pk_val > 50000000000:
                                                    account_created_hint = "Recent Account (2021-2026)"
                                                elif pk_val > 1000000000:
                                                    account_created_hint = "Mid-Era Account (2016-2020)"
                                                else:
                                                    account_created_hint = "OG Account (Pre-2016)"
                                                ...
                                                profile_card = (
                                                    ...
                                                    f"☑️ 𝗠𝗘𝗧𝗔 𝗩𝗘𝗥𝗜𝗙𝗜𝗘𝗗 ➜ {is_verified}\n"
                                                    f"📅 𝗖𝗥𝗘𝗔𝗧𝗜𝗢𝗡 𝗗𝗔𝗧𝗘 ➜ {account_created_hint}\n\n"
                                                    f"🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}\n"
                                                    f"👑 𝗗𝗘𝗩 ➜ {OWNER_USERNAME}"
                                                )
                                ...
                                if text_lower == "!security":
                                    if is_dev:
                                        sec_status = "🔒 LOCKED DOWN (Active)" if LOCKDOWN_MODE else "🟢 SECURE & NORMAL"
                                        sec_card = (
                                            f"🛡️🔒 𝗚𝗖 𝗦𝗘𝗖𝗨𝗥𝗜𝗧𝗬 • 𝗦𝗧𝗔𝗧𝗨𝗦 𝗖𝗔𝗥𝗗 🔒🛡️\n\n"
                                            f"⚡ 𝗠𝗢𝗗𝗘 ➜ {sec_status}\n"
                                            f"🚫 𝗔𝗕𝗨𝗦𝗘 / 𝟭𝟴+ 𝗙𝗜𝗟𝗧𝗘𝗥 ➜ `ACTIVE`\n"
                                            f"🔗 𝗥𝗘𝗘𝗟𝗦 / 𝗟𝗜𝗡𝗞 𝗕𝗟𝗢𝗖𝗞𝗘𝗥 ➜ `ACTIVE`\n"
                                            f"⚡ 𝗔𝗡𝗧𝗜-𝗙𝗟𝗢𝗢𝗗 𝗦𝗣𝗔𝗠 ➜ `ACTIVE`\n\n"
                                            f"🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}\n"
                                            f"👑 𝗗𝗘𝗩 ➜ {OWNER_USERNAME}"
                                        )
                                ...
                                if is_dev:
                                    if text_lower == "!lockdown":
                                        ...
                                        if len(parts) > 1:
                                            ...
                                            safe_send_message(thread_id, f"🎯🎯 **TARGET LOCKED**\n\nUser {fix_mention(target)} will be kicked on sight.\n\n🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}", reply_test_item_id=message_id if 'message_id' in locals() else None)
                                        continue
