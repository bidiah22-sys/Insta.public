...
# Environment Variables लोड करना (अगर .env फ़ाइल मौजूद हो)
load_dotenv()
...
class ProfileEngine:
    ...
    def record_activity(user_id: str, username: str):
        ...
        try:
            ...
            if not profile:
                profile = UserProfile(user_id=str(user_id), username=username)
                db.add(profile)
            
            profile.username = username
            profile.total_messages += 1
            profile.last_active = datetime.utcnow()
            profile.trust_score = min(100.0, profile.trust_score + 0.1)
            db.commit()
        finally:
            db.close()
    ...
    def _register_violation(user_id: str, group_id: str, v_type: str):
        ...
        try:
            ...
            if profile:
                ...
                profile.trust_score = max(0.0, profile.trust_score - 10.0)
                profile.risk_score = min(100.0, profile.risk_score + 15.0)
                    ...
                    for thread in threads:
                        ...
                        if messages:
                            ...
                            if message_id and message_id not in seen_message_ids:
                                ...
                                # यूज़र एक्टिविटी और डेटाबेस अपडेट
