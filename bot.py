...
def start_bot():
    while True:
        try:
            ...
            # सेशन आईडी से सेफ और डायरेक्ट लॉगिन
            cl.login_by_sessionid(SESSION_ID)
            print(f"[+] SUCCESS: Bot @{BOT_USERNAME} is LIVE with Ultra Pro Session Security! 🚀")
            ...
            while True:  
                try:  
                    ...
                    for thread in threads:  
                        ...
                        # ----------------------------------
                        # 🔒 MANDATORY ADMIN CHECK (बिना एडमिन चुप रहेगा)
                        # ----------------------------------
                        try:
                        ...
                        # अगर बोट इस ग्रुप में एडमिन नहीं है, तो आगे कोई एक्शन नहीं लेगा!
                        if not is_bot_admin:
                            continue
