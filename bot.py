...
def start_bot():
    global LOCKDOWN_MODE, SHADOWBANNED_USERS, TARGETED_USERS, SEEN_MEMBERS
    init_db()
                ...
                try:
                    ...
                    for thread in threads:
                        ...
                        for u in users:
                            ...
                            if u_pk and u_name and u_pk != bot_pk:
                                unique_key = f"{thread_id}_{u_pk}"
                                if unique_key not in SEEN_MEMBERS:
                                    SEEN_MEMBERS.add(unique_key)
                                    welcome_card = (
                                        f"👋✨ **𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗧𝗛𝗘 𝗚𝗖!** ✨👋\n\n"
                                        f"👤 𝗡𝗘𝗪 𝗠𝗘𝗠𝗕𝗘𝗥 ➜ {fix_mention(u_name)}\n"
                            ...
                            if message_id and message_id not in seen_message_ids:
                                ...
                                if text_lower in ["!members", "!memberlist"]:
                                    if is_dev or is_sender_admin:
                                        ...
                                        safe_send_message(thread_id, "⚠️ **Access Denied:** Admins/Devs only!")
                                    continue
                                ...
                                # 6. DETAILED USER INFO / PROFILE COMMAND (RESTORED!)
