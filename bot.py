...
def start_bot():
    while True:
        try:
            ...
            print(f"[+] SUCCESS: Bot @{BOT_USERNAME} is LIVE with Ultimate Stability & Admin Safeguard! 🚀")
            ...
            def safe_send_message(thread_id, text_content):
                ...
                time.sleep(2) # सुरक्षित डिले ताकि 403 न आए

            while True:  
                try:  
                    # 403 एरर से बचने के लिए लिमिटेड अमाउंट में थ्रेड्स फेच करना
                    ...
                    for thread in threads:  
                        ...
                        # 🛑 सबसे जरूरी नियम: अगर जीसी में एडमिन नहीं मिला, तो बोट कोई काम नहीं करेगा!
                        if not gc_admins:
                            continue
                        ...
                        if messages:  
                            ...
                            if message_id and message_id not in seen_message_ids:  
                                ...
                                # 4. @everyone या @bot टैग करने पर रिप्लाई  
                    ...
                    print(f"[LOOP ERROR / RATE LIMIT] {inner_e}")  
                    time.sleep(20) # एरर आने पर थोड़ा लंबा ब्रेक ताकि 403 शांत हो जाए

                time.sleep(12)  # लूप के बीच सुरक्षित गैप (ताकि इंस्टाग्राम ब्लॉक न मारे)

        except Exception as outer_e:  
            print(f"[-] RECONNECTING DUE TO CONNECTION/403 ERROR... Waiting 60 seconds: {outer_e}")  
            time.sleep(60)
