...
POLL_INTERVAL = 1  # Ultra-fast response time
...
# --- Advanced Abusive & Toxicity Word Patterns ---
BAD_WORD_PATTERNS = [
    ...
    r'dick\w*', r'cock\w*', r'porn\w*', r'xnxx\w*', r'xhamster\w*', r'madarchod',
    r'bhenchod', r'chutiya', r'gandu', r'bhosdike'
]
...
RESTRICTED_WORDS = set([
    ...
    'sex', 'porn', 'xnxx', 'xhamster', 'hotvideo', '18plus', 'xxx', 'bra', 'panty'
])
...
class ModerationEngine:
    ...
    def get_user_stats(username: str) -> str:
        ...
        try:
            ...
            return (
                f"📊✨ 𝗨𝗦𝗘𝗥 𝗦𝗧𝗔𝗧𝗦 • 𝗧𝗥𝗨𝗦𝗧 𝗖𝗔𝗥𝗗 ✨📊\n\n"
                f"❌ User {fix_mention(clean_user)} is not registered in Database yet!\n\n"
                f"🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}\n"
                f"👑 𝗗𝗘𝗩 ➜ {OWNER_USERNAME}"
            )
        finally:
    ...
    def get_top_chatters() -> str:
        ...
        try:
            ...
            if not top_users:
                return (
                    f"🏆👑 𝗧𝗢𝗣 𝗖𝗛𝗔𝗧𝗧𝗘𝗥𝗦 • 𝗟𝗘𝗔𝗗𝗘𝗥𝗕𝗢𝗔𝗥𝗗 👑🏆\n\n"
                    f"⚠️ No active users found in database yet!\n\n"
                    f"🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}\n"
                    f"👑 𝗗𝗘𝗩 ➜ {OWNER_USERNAME}"
                )
...
def start_bot():
    ...
    while True:
        try:
            ...
            print(f"[+] SUCCESS: Bot @{BOT_USERNAME} ULTRA PRO MAX MODE ACTIVE! 🚀🔥")
            ...
            def execute_kick(thread_id, target_pk, target_username, reason, admin_tags, silent=False):
                try:
                    ...
                    if not silent:
                        kick_card = (
                            f"🚨🚪 𝗨𝗟𝗧𝗥𝗔-𝗞𝗜𝗖𝗞 • 𝗘𝗟𝗜𝗠𝗜𝗡𝗔𝗧𝗜𝗢𝗡 🚪🚨\n\n"
                            f"👤 𝗢𝗙𝗙𝗘𝗡𝗗𝗘𝗥 ➜ {fix_mention(target_username)}\n"
                            f"🆔 𝗨𝗦𝗘𝗥 𝗜𝗗 ➜ `{target_pk}`\n"
                            f"🚫 𝗥𝗘𝗔𝗦𝗢𝗡 ➜ {reason}\n"
                            f"🛑 𝗦𝗧𝗔𝗧𝗨𝗦 ➜ 𝗜𝗡𝗦𝗧𝗔𝗡𝗧𝗟𝗬 𝗥𝗘𝗠𝗢𝗩𝗘𝗗\n\n"
                            f"📢 𝗔𝗗𝗠𝗜𝗡𝗦 ➜ {admin_tags}\n"
                            f"🛡️ 𝗚𝗖 𝗜𝗦 𝗡𝗢𝗪 𝗦𝗔𝗙𝗘 & 𝗖𝗟𝗘𝗔𝗡\n\n"
                            f"🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}\n"
                            f"👑 𝗗𝗘𝗩 ➜ {OWNER_USERNAME}"
                        )
                        ...
                        if thread_id not in thread_known_members:
                            ...
                            for new_pk in new_members:
                                ...
                                welcome_card = (
                                    ...
                                    f"🔥 𝗦𝗧𝗔𝗬 𝗔𝗖𝗧𝗜𝗩𝗘 & 𝗥𝗘𝗦𝗣𝗘𝗖𝗧𝗙𝗨𝗟\n"
                                    f"📜 𝗣𝗟𝗘𝗔𝗦𝗘 𝗖𝗛𝗘𝗖𝗞 𝗥𝗨𝗟𝗘𝗦 ➜ `!rules`\n\n"
                                    f"🌷 𝗘𝗡𝗝𝗢𝗬 𝗬𝗢𝗨𝗥 𝗧𝗜𝗠𝗘 𝗛𝗘𝗥𝗘 🌷\n\n"
                                    f"🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}\n"
                                    f"👑 𝗗𝗘𝗩 ➜ {OWNER_USERNAME}"
                                )
                        ...
                        if messages:
                            ...
                            if message_id and message_id not in seen_message_ids:
                                ...
                                if not is_dev:
                                    ...
                                    user_message_timestamps[sender_id] = [t for t in user_message_timestamps[sender_id] if current_t - t < 5]
                                    user_message_timestamps[sender_id].append(current_t)
                                    
                                    if len(user_message_timestamps[sender_id]) > 5:
                                        execute_kick(thread_id, sender_id, sender_username, "Anti-Flood Rapid Spam Triggered", admin_mentions_tag)
                                        continue
                                ...
                                # --- ULTRA-STRICT ZERO-TOLERANCE MODERATION (ABUSE, LINKS, 18+ CONTENT/VIDEOS/STICKERS) ---
                                if not is_dev:
                                    is_abuse = is_abusive_text(text)
                                    is_link = "http" in text_lower or "www." in text_lower or "instagram.com" in text_lower or "t.me" in text_lower or "bit.ly" in text_lower
                                    
                                    # Detect media items like videos, voice notes, stickers, or media shares that could be 18+ spam
                                    is_suspicious_media = item_type in ["media", "visual_media", "raven_media", "clip", "story_share"]
                                    
                                    # Keywords indicating 18+ media description
                                    is_nsfw_text = any(word in text_lower for word in ['18+', 'adult', 'xxx', 'sex', 'porn', 'hot video', 'bra', 'panty', 'xnxx', 'xhamster'])

                                    if is_abuse or is_link or is_nsfw_text or (is_suspicious_media and (is_abuse or is_nsfw_text)):
                                        violation_reason = "Abusive / Toxic Language Detected" if is_abuse else ("Unauthorized Link / Spam" if is_link else "18+ / NSFW Content or Media")
                                        ModerationEngine.record_violation(sender_username)
                                        execute_kick(thread_id, sender_id, sender_username, violation_reason, admin_mentions_tag)
                                        continue

                                # --- ABSOLUTE DEVELOPER-ONLY COMMANDS WITH CARDS ---
                                ...
                                if text_lower == "!rules":
                                    if is_dev:
                                        ...
                                        safe_send_message(thread_id, f"⚠️🔒 **ACCESS DENIED CARD**\n\n👤 𝗨𝗦𝗘𝗥 ➜ {fix_mention(sender_username)}\n❌ 𝗥𝗘𝗔𝗦𝗢𝗡 ➜ Developers Only Command\n\n🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}\n👑 𝗗𝗘𝗩 ➜ {OWNER_USERNAME}")
                                    continue
                                ...
                                if text_lower in ["!ping", "!alive"]:
                                    if is_dev:
                                        ping_card = (
                                            f"⚡🏓 𝗕𝗢𝗧 𝗔𝗟𝗜𝗩𝗘 • 𝗣𝗜𝗡𝗚 𝗖𝗛𝗘𝗖𝗞 🏓⚡\n\n"
                                            f"🚀 𝗦𝗧𝗔𝗧𝗨𝗦 ➜ 𝗨𝗟𝗧𝗥𝗔 𝗣𝗥𝗢 𝗠𝗔𝗫 𝗢𝗡𝗟𝗜𝗡𝗘\n"
                                            f"💨 𝗦𝗣𝗘𝗘𝗗 ➜ 𝟬.𝟭𝘀 (𝗜𝗡𝗦𝗧𝗔𝗡𝗧)\n"
                                            f"🛡️ 𝗦𝗘𝗖𝗨𝗥𝗜𝗧𝗬 ➜ 𝗭𝗘𝗥𝗢 𝗧𝗢𝗟𝗘𝗥𝗔𝗡𝗖𝗘\n\n"
                                            f"🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}\n"
                                            f"👑 𝗗𝗘𝗩 ➜ {OWNER_USERNAME}"
                                        )
                                        safe_send_message(thread_id, ping_card)
                                    else:
                                        safe_send_message(thread_id, f"⚠️🔒 **ACCESS DENIED CARD**\n\n👤 𝗨𝗦𝗘𝗥 ➜ {fix_mention(sender_username)}\n❌ 𝗥𝗘𝗔𝗦𝗢𝗡 ➜ Developers Only Command\n\n🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}\n👑 𝗗𝗘𝗩 ➜ {OWNER_USERNAME}")
                                    continue
                                ...
                                if text_lower == "!botinfo":
                                    if is_dev:
                                        info_card = (
                                            f"🤖📊 𝗕𝗢𝗧 𝗜𝗡𝗙𝗢 • 𝗦𝗬𝗦𝗧𝗘𝗠 𝗦𝗧𝗔𝗧𝗨𝗦 📊🤖\n\n"
                                            f"⚡ 𝗦𝗧𝗔𝗧𝗨𝗦 ➜ 𝟭𝟬𝟬% 𝗢𝗡𝗟𝗜𝗡𝗘\n"
                                            f"🛡️ 𝗠𝗢𝗗𝗘𝗥𝗔𝗧𝗜𝗢𝗡 ➜ 𝗜𝗡𝗦𝗧𝗔𝗡𝗧 𝗔𝗨𝗧𝗢-𝗞𝗜𝗖𝗞\n"
                                            f"🔥 𝗔𝗕𝗨𝗦𝗘 & 𝟭𝟖+ 𝗙𝗜𝗟𝗧𝗘𝗥 ➜ 𝗔𝗖𝗧𝗜𝗩𝗘\n\n"
                                            f"🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}\n"
                                            f"👑 𝗗𝗘𝗩 ➜ {OWNER_USERNAME}"
                                        )
                                ...
                                if text_lower in ["!help", "!commands", "!menu"]:
                                    if is_dev:
                                        ...
                                        safe_send_message(thread_id, help_card)
                                    else:
                                        safe_send_message(thread_id, f"⚠️🔒 **ACCESS DENIED CARD**\n\n👤 𝗨𝗦𝗘𝗥 ➜ {fix_mention(sender_username)}\n❌ 𝗥𝗘𝗔𝗦𝗢𝗡 ➜ Developers Only Command\n\n🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}\n👑 𝗗𝗘𝗩 ➜ {OWNER_USERNAME}")
                                    continue
                                    ...
                                    if is_dev:
                                        ...
                                        try:
                                            ...
                                            if u_info:
                                                ...
                                                safe_send_message(thread_id, f"❌📸 **ERROR CARD**\n\nFailed to fetch DP for {fix_mention(target_name)}!\n\n🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}\n👑 𝗗𝗘𝗩 ➜ {OWNER_USERNAME}")
                                        except Exception:
                                            safe_send_message(thread_id, f"❌📸 **ERROR CARD**\n\nDP Fetch Exception Occurred!\n\n🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}\n👑 𝗗𝗘𝗩 ➜ {OWNER_USERNAME}")
                                    else:
                                        safe_send_message(thread_id, f"⚠️🔒 **ACCESS DENIED CARD**\n\n👤 𝗨𝗦𝗘𝗥 ➜ {fix_mention(sender_username)}\n❌ 𝗥𝗘𝗔𝗦𝗢𝗡 ➜ Developers Only Command\n\n🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}\n👑 𝗗𝗘𝗩 ➜ {OWNER_USERNAME}")
                                    continue
                                    ...
                                    if is_dev:
                                        ...
                                        try:
                                            ...
                                            if u_info:
                                                ...
                                                safe_send_message(thread_id, f"❌👤 **ERROR CARD**\n\nUser {fix_mention(target_name)} not found!\n\n🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}\n👑 𝗗𝗘𝗩 ➜ {OWNER_USERNAME}")
                                        except Exception:
                                            safe_send_message(thread_id, f"❌👤 **ERROR CARD**\n\nProfile Fetch Exception Occurred!\n\n🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}\n👑 𝗗𝗘𝗩 ➜ {OWNER_USERNAME}")
                                    else:
                                        safe_send_message(thread_id, f"⚠️🔒 **ACCESS DENIED CARD**\n\n👤 𝗨𝗦𝗘𝗥 ➜ {fix_mention(sender_username)}\n❌ 𝗥𝗘𝗔𝗦𝗢𝗡 ➜ Developers Only Command\n\n🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}\n👑 𝗗𝗘𝗩 ➜ {OWNER_USERNAME}")
                                    continue
                                ...
                                # 11. Dev Control Commands (!lockdown, !unlock, !target)
                                if is_dev:
                                    if text_lower == "!lockdown":
                                        LOCKDOWN_MODE = True
                                        safe_send_message(thread_id, f"🚨🔒 **LOCKDOWN CARD**\n\nSTATUS ➜ ACTIVATED\nNon-dev messages will be kicked instantly.\n\n🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}\n👑 𝗗𝗘𝗩 ➜ {OWNER_USERNAME}")
                                        continue
                                    elif text_lower == "!unlock":
                                        LOCKDOWN_MODE = False
                                        safe_send_message(thread_id, f"🔓✨ **UNLOCK CARD**\n\nSTATUS ➜ DEACTIVATED\nGroup is back to normal.\n\n🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}\n👑 𝗗𝗘𝗩 ➜ {OWNER_USERNAME}")
                                        continue
                                        ...
                                        if len(parts) > 1:
                                            ...
                                            safe_send_message(thread_id, f"🎯🎯 **TARGET CARD**\n\nUSER ➜ {fix_mention(target)}\nSTATUS ➜ ADDED (Will be kicked on sight)\n\n🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}\n👑 𝗗𝗘𝗩 ➜ {OWNER_USERNAME}")
                                        continue
