...
def start_bot():
    while True:
        try:
            ...
            cl = Client()
            # Railway के लिए बेस्ट डिले ताकि 403 न आए और स्पीड भी तेज रहे
            cl.delay_range = [1, 3]
            cl.login(BOT_USERNAME, BOT_PASSWORD)
            print(f"[+] SUCCESS: Bot @{BOT_USERNAME} is LIVE with High-Speed Clean Core! 🚀")
            ...
            while True:
                try:
                    # रेलवे पर स्मूथ रन के लिए 3 थ्रेड्स की लिमिटेड पोलिंग
                    ...
                    for thread in threads:
                        ...
                        # 1. WELCOME & WELCOME BACK LOGIC (INSTANT & CLEAN)
                                    ...
                                    if user_obj:
                                        ...
                                        # Fresh Welcome Card
                                            ...
                                            welcome_card = (
                                                ...
                                                f"🤝 𝗦𝗧𝗔𝗬 𝗥𝗘𝗦𝗣𝗘𝗖𝗧𝗙𝗨𝗟 • 𝗙𝗢𝗟𝗟𝗢𝗪 𝗧𝗛𝗘 𝗥𝚄𝗟𝗘𝗦\n"
                                ...
                                if not is_sender_admin:
                                    ...
                                    if item_type in ['clip', 'media', 'video', 'visual_media'] or '/reel/' in text_lower or 'video' in item_type:
                                        reel_msg = (
                                            f"🚫🎬 𝗥𝗘𝗘𝗟𝗦 𝗡𝗢𝗧 𝗔𝗟𝗟𝗢𝗪𝗘𝗗!\n\n"
                                            f"👤 @{sender_username}\n\n"
                                            f"⚠️ 𝗥𝗘𝗘𝗟𝗦 / 𝗩𝗜𝗗𝗘𝗢𝗦 𝗔𝗥𝗘 𝗡𝙾𝗧 𝗔𝗟𝗟𝗢𝗪𝗘𝗗 𝗛𝙴𝗥𝗘.\n\n"
                    ...
                    # अगर कभी गलती से 403 आए भी, तो बिना क्रैश हुए 10 सेकंड में खुद को संभाल लेगा
                    if "403" in err_str or "feedback_required" in err_str:
                        time.sleep(10)
                    else:
                        time.sleep(2)

                time.sleep(1) # सुपर-फास्ट रिस्पांस के लिए मिनिमम डिले
