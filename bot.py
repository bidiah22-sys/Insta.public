...
SESSION_ID = ("28257191991%3AXkxM8kUs2lBMhz%3A15%3AAYnoWpLKr5t_miN6pDVnAGIf1WQ-Vu5ymzMrIsVsUA")
...
def initialize_client():
    ...
    if os.path.exists(SESSION_FILE):
        try:
            ...
            print("[+] Loaded settings from local file.")
        except Exception:
            pass
                ...
                try:
                    ...
                    if not silent:
                        kick_card = (
                            ...
                            f"💀 𝗠𝗘𝗦𝗦𝗔𝗚𝗘  ➜ Zero Tolerance Active!\n"
                            f"───━━━━━━━━━━━━━━━━━━━━━━━━━━━━───\n"
                            f"🤖 𝗕𝗢𝗧 ➜ @{BOT_USERNAME}\n"
                            f"👨‍💻 𝗗𝗘𝗩 ➜ @{OWNER_USERNAME}"
                        )
