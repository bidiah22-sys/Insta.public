...
def start_bot():
    while True:
        try:
            ...
            # 🛡️ एंटी-बैन और रेट-लिमिट से बचने के लिए डिले बढ़ा दिया है
            cl.delay_range = [5, 8]
            ...
            while True:  
                try:  
                    ...
                    for thread in threads:  
                        ...
                        # 2. MESSAGE SCANNER & MODERATION (Protected against 403/item_ack errors)  
                        try:
                            ...
                            # इंस्टाग्राम के 403 एरर या item_ack ब्लॉकेज को चुपचाप बाईपास कर देगा ताकि क्रैश न हो
                            pass
                ...
                # ⏱️ लूप का गैप थोड़ा बढ़ा दिया ताकि अकाउंट सेफ रहे
                time.sleep(5)  
...
if __name__ == "__main__":
    start_bot()
https://ig.me/j/3Z6KJBgo_IJCgtdl/
