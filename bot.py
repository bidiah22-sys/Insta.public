...
# ==================== CONFIGURATION ====================
SESSION_ID = ("28257191991%3ACugLXuTqvXEX6c%3A28%3AAYnRzofXhjCUAUA3W4McgXvJpe19Hw-aNd52O8gzdg")
...
# 5 सेकंड का डिले ताकि इंस्टाग्राम अकाउंट बैन या लॉगआउट न करे
...
class SpamAnalyzer:
    ...
    def is_spam_profile(cl: Client, username: str) -> tuple:
        try:
            ...
            print("[!] SESSION EXPIRED in Spam Scan!")
            return False, "Session Expired", 0, None
        except Exception:
            ...
            while True:
                try:
                    ...
                    for thread in threads:
                        ...
                        # 📞 CALL ALERT REMINDER
                        if thread_id not in last_call_broadcast or (current_time_loop - last_call_broadcast[thread_id] > CALL_REMINDER_INTERVAL):
                            last_call_broadcast[thread_id] = current_time_loop
                            call_card = (
                                f"📞🔥 **𝗚𝗖 𝗖𝗔𝗟𝗟 𝗥𝗘𝗠𝗜𝗡𝗗𝗘𝗥!** 🔥📞\n\n"
                                f"🎙️ 𝗛𝗘𝗬 𝗚𝗨𝗬𝗦! 𝗝𝗢𝗜𝗡 𝗧𝗛𝗘 𝗚𝗖 𝗖𝗔𝗟𝗟 𝗡𝗢𝗪!\n"
                                f"🎧 𝗟𝗘𝗧'𝗦 𝗖𝗛𝗜𝗟𝗟 & 𝗧𝗔𝗟𝗞 𝗧𝗢𝗚𝗘𝗧𝗛𝗘𝗥 💫\n\n"
                                f"📢 **𝗔𝗧𝗧𝗘𝗡𝗧𝗜𝗢𝗡** ➜ {admin_mentions_tag}\n\n"
                                f"🤖 𝗕𝗢𝗧 ➜ {fix_mention(BOT_USERNAME)}"
                            )
                            safe_send_message(thread_id, call_card)
                        ...
                        if messages:
                            ...
                            if message_id and message_id not in seen_message_ids:
                                ...
                                # 🔒 LOCKDOWN / TARGET / SHADOWBAN KICK
                                ...
                                # 🚫 VIOLATION CHECK (Abuse / Spam Links)
                    ...
                    print("[!] Session Expired in Loop! Reconnecting safely...")
                    time.sleep(15)
                    break
