...
SESSION_ID = "27413581604%3AouSmyrPKPDgZ9t%3A22%3AAYj1HtAB90lP104ze_KkGVJ9ZXQcu2lY-mCLoX8ZHAL"
...
def start_bot():
    while True:
        try:
            ...
            try:
                # 🛡️ रेट-लिमिट (403) से बचने के लिए डिले और बढ़ा दिया है
                cl.delay_range = [8, 12]
            except Exception:
                pass
            ...
            while True:  
                                ...
                                if message_id and message_id not in seen_message_ids:  
                                    ...
                                    if "@everyone" in text_lower or bot_tag in text_lower:  
                                        response_msg = (  
                                            ...
                                            f"🤖 𝗕𝗢𝗧 𝗜𝗦 𝗔𝗖𝗧𝗜𝗩𝗘 𝗔𝗡𝗗 𝗠𝗔𝗡𝗔𝗚𝗜𝗡𝗚 𝗧𝗛𝗘 𝗚𝗖 SMOOTHLY. 🚀\n\n"  
                                            f"🤖 𝗕𝗢𝗧 ➜ @{BOT_USERNAME}\n"  
                                            f"👨‍💻 𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥 ➜ @{OWNER_USERNAME}"  
                                        )  
                ...
                # ⏱️ हर लूप के बीच का रेस्ट टाइम बढ़ाकर 10 सेकंड कर दिया है ताकि 403 एरर कभी न आए
                time.sleep(10)  
