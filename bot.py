...
def start_bot():
    while True:
        try:
            ...
            print(f"[+] SUCCESS: Bot @{BOT_USERNAME} is LIVE with 8-9 Sec Quick Recovery! 🚀")
            ...
            while True:
                try:
                    ...
                    # सिर्फ 8 से 9 सेकंड का सुपर-फास्ट रिकवरी ब्रेक
                    if "403" in err_str or "feedback_required" in err_str or "item_ack" in err_str:
                        print("[!] Rate limit hit. Quick recovering in 8 seconds...")
                        time.sleep(8)
                    else:
                        time.sleep(3)

                time.sleep(3) # नॉर्मल पोलिंग डिले
