...
SESSION_ID = os.getenv("SESSION_ID", "28257191991%3AhNvGpKqnzo6qRL%3A5%3AAYkycEpChM6TAA_ckLcYlXcbCDtm5o6sXEmqYUgwJQ")
PROXY_URL = os.getenv("PROXY_URL", "") # Format: http://user:pass@ip:port
...
def initialize_client():
    ...
    # Device Spoofing (Emulate Mobile Device)
    cl.set_device({
    ...
    # Load session if file exists to prevent re-login lock
    ...
    if SESSION_ID:
        try:
            ...
            cl.dump_settings(SESSION_FILE) # Save session state
            return cl
