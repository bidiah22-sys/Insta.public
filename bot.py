...
def start_bot():
    while True:
        try:
            ...
            print(f"[+] SUCCESS: Bot @{BOT_USERNAME} is LIVE with Morning/Night Wishes & 1-Hour Call Reminders! 🚀")
            ...
            # विशेस (Morning/Night) के लिए ट्रैक करने के लिए ताकि एक दिन में बार-बार न जाए
            ...
            while True:  
                try:  
                    ...
                    # वर्तमान समय (घंटा और मिनट निकालने के लिए)
                    now = datetime.now()
                    ...
                    for thread in threads:  
                        ...
                        # 2. MORNING & NIGHT WISH SYSTEM (सुबह 6:00 बजे और रात 11:00 बजे)
                        global last_morning_wish_date, last_night_wish_date
                        
                        # सुबह 6:00 बजे (जैसे ही 6:00 से 6:05 के बीच लूप चले)
                        ...
                        # रात 11:00 बजे (23:00 से 23:05 के बीच)
