...
# ==================== CONFIGURATION ====================
SESSION_ID = ("28257191991%3AutuqwgXHWFkaxI%3A12%3AAYkplen6NMgYWajpdYdioSwbGtE9xwqAlL3YCXYN3g")
...
# 12 सेकंड का सेफ गैप ताकि इंस्टाग्राम ब्लॉक या लॉगआउट न करे
...
def start_bot():
    ...
    while True:
        try:
            print("[*] Connecting to Instagram Engine with Anti-Logout Protection...")
            cl = Client()
            
            # एंड्रॉइड डिवाइस सिमुलेशन (ताकि इंस्टाग्राम बॉट न समझे)
            cl.set_device({
                ...
                "model": "OnePlus5",
                "cpu": "qcom",
                "version_code": "314665258"
            })

            # ऑटोमेटेड सेशन री-यूज़ लॉजिक
            if os.path.exists(SESSION_FILE):
                try:
                    cl.load_settings(SESSION_FILE)
                    cl.login_by_sessionid(SESSION_ID.strip())
                    print("[+] Session loaded securely from local cache!")
                except Exception:
                    cl.login_by_sessionid(SESSION_ID.strip())
            ...
            print(f"[+] SUCCESS: Bot @{BOT_USERNAME} IS NOW PERMANENTLY ONLINE! 🚀⚡")
            ...
            while True:
                try:
                    ...
                    print("[!] Temporary Session Glitch! Auto-reconnecting in 15s...")
                    time.sleep(15)
                    break
                except (PleaseWaitFewMinutes, ClientThrottledError):
                    print("[!] Rate Limit Warning. Sleeping for 2 mins...")
                    time.sleep(120)
